...
export class initAllEntity1659432559106 implements MigrationInterface {
    name = 'initAllEntity1659432559106'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "product-to-category" ("created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP WITH TIME ZONE, "version" integer NOT NULL DEFAULT '1', "id" SERIAL NOT NULL, "product_key" character varying, "category_key" character varying, CONSTRAINT "PK_ea99ce2dc8594e7781a3ef0308e" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "product-to-category" ADD CONSTRAINT "FK_74e842980a178046c4c031a24f0" FOREIGN KEY ("product_key") REFERENCES "product"("key") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "product-to-category" ADD CONSTRAINT "FK_1dd4e92f441c63a483ffab7d438" FOREIGN KEY ("category_key") REFERENCES "category"("key") ON DELETE CASCADE ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "product-to-category" DROP CONSTRAINT "FK_1dd4e92f441c63a483ffab7d438"`);
        await queryRunner.query(`ALTER TABLE "product-to-category" DROP CONSTRAINT "FK_74e842980a178046c4c031a24f0"`);
